...
<!--            <li class="third columns widget-box">-->
                <h4 class="widget-title">Revista Exégesis</h4>
                <ul class="menu-footer">
                    <?php get_template_part( 'parts/shared/menu' ); ?>
                </ul>
<!--
                <h4 class="clear widget-title">¡Únete a la comunidad!</h4>
...
-->
        <div class="sub-footer">
            <div class="interior">
                ...
                <a rel="license" href="http://creativecommons.org/licenses/by-nc-nd/3.0/"><img alt="Creative Commons License" style="border-width:0" src="//i.creativecommons.org/l/by-nc-nd/3.0/88x31.png"></a>
                ...
                <ul class="icon-footer">
                    <li><a title="WordPress - Plataforma Semántica de Publicación" class="icon icon-wordpress" href="http://wordpress.org/"><span>WordPress</span></a> </li>
                    <li><a title="HTML5" href="#" class="icon icon-html5"><span>HTML5</span></a></li>
                    <li><a title="CSS3" href="#" class="icon icon-css3"><span>CSS3</span></a></li>
                </ul>
            </div><!-- .interior -->
        </div><!-- .subfooter -->
    </footer><!--.footer-->
